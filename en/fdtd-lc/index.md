...
{{< image src="./images/LC_rot_obj.webp" caption="" title="" width="15%" height="15%">}}
...
{{< image src="./images/LC_twist_z_axis.png" caption="" title="LC_twist_z_axis" width="30%" height="30%" >}}
